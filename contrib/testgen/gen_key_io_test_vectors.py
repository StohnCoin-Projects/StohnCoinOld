...
bech32_templates = [
  ...
  ('soh',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('soh',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('soh',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tsoh',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tsoh',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tsoh',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rsoh',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rsoh',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rsoh', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tsoh',  17, 32, False, False, False),
  ('rsoh',  3,  1, False, False, False),
  ('soh',   15, 41, False, False, False),
  ('tsoh',  0, 16, False, False, False),
  ('rsoh',  0, 32, True,  False, False),
  ('soh',   0, 16, True,  False, False),
  ('tsoh',  0, 32, False, True,  False),
  ('rsoh',  0, 20, False, False, True)
]
